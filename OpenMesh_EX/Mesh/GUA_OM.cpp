...
// 特別的向量
const OMT::Vec3d Tri_Mesh::ZERO = OMT::Vec3d(0, 0, 0);    // (0,0,0)
const OMT::Vec3d Tri_Mesh::UNIT_X = OMT::Vec3d(1, 0, 0);  // (1,0,0)
const OMT::Vec3d Tri_Mesh::UNIT_Y = OMT::Vec3d(0, 1, 0);  // (0,1,0)
const OMT::Vec3d Tri_Mesh::UNIT_Z = OMT::Vec3d(0, 0, 1);  // (0,0,1)
const OMT::Vec3d Tri_Mesh::ONE = OMT::Vec3d(1, 1, 1);     // (1,1,1)
